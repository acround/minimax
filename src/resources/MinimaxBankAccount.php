...
namespace acround\Minimax\resources;

use acround\Minimax\MinimaxHttpClient;
use acround\Minimax\MinimaxResource;
use acround\Minimax\exceptions\MinimaxApiException;
